      ...
      return (
        <div className="min-h-screen bg-background-light dark:bg-background-dark flex flex-col font-display">
            <header className="flex items-center p-4">
                <button onClick={() => navigate(-1)} className="p-2"><span className="material-symbols-outlined text-slate-900 dark:text-white">arrow_back</span></button>
            </header>
            <main className="flex-1 flex flex-col items-center justify-center p-6 text-center pb-20 animate-[fade-in_0.5s]">
                ...
                <p className="text-slate-500 dark:text-slate-400 mb-8 max-w-xs leading-relaxed text-sm">
                    Automatize sua organização. Defina regras para que o FinControl categorize suas transações sozinho baseando-se no nome.
                    <br/><br/>
    ...
    <div className="bg-background-light dark:bg-background-dark min-h-screen flex flex-col font-display">
      ...
      <main className="p-4 space-y-6">
        ...
        <div className="space-y-3">
           ...
           {rules.length === 0 && <p className="text-sm text-slate-500 px-1 italic">Nenhuma regra criada.</p>}
